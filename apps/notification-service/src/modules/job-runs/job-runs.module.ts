...
/**
 * The heartbeat, deduplicated.
 *
 * **The behaviour lives once, in `libs/common`; the TABLE stays here.** Four
 ...
 * of code across what is now four services, which is what moved.
 *
