/**
 * @file The embedding capability, as an interface plus a token.
 *
 * A TypeScript interface is erased at compile time and cannot be an injection
 * token, so the symbol below is what modules actually bind. The value of
 ...
 * real Qdrant upserts.
 *
 * Any substitute must honour this contract completely: same return
