...
| Swagger | `http://localhost:3000/api/v1/docs`, with `SWAGGER_ENABLED = true`; the same document as a tracked file at [`docs/reference/openapi.json`](docs/reference/openapi.json), regenerated by `npm run openapi:export` |
